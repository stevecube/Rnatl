...
const tenth = document.getElementById('answer10');
let a;
...
function duplicate_check() {
    ...
    const random10 = questions[Math.floor(Math.random() * questions.length)];
    if (random10 == questions[0]) {
        num = 'first';
        numcheck(num);
    }
